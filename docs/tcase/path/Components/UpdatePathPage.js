...
var UpdatePathPage = React.createClass({
    ...
    onClickSave: function () {
        if (Validator.formValidator(this, this.state.path)) {
            ...
            PathActions.updateTmCase(this.state.path );
        }
    },
    ...
    render: function () {
        ...
        return (
            ...
            >
                <Form layout={layout}>
                    <FormItem {...formItemLayout} label="目录名称" colon={true} className={layoutItem} help={hints.cateNameHint} validateStatus={hints.cateNameStatus}>
                        <Input type="text" name="cateName" id="cateName" value={this.state.path.cateName} onChange={this.handleOnChange} />
                    </FormItem>
