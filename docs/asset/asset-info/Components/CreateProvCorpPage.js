...
var CreateProvCorpPage = React.createClass({
    ...
    clear: function (filter) {
        // FIXME 输入参数，对象初始化
        this.state.hints = {};
        this.state.provCorp.uuid = '';
        this.state.provCorp.filter = filter;
        this.state.provCorp.cityName = '';
        this.state.provCorp.provName = '';
        this.state.provCorp.provLevel = '临时';
        this.state.provCorp.provType = '';
        this.state.provCorp.merchType = '';
        this.state.provCorp.provScope = '';
        this.state.provCorp.address = '';
        this.state.provCorp.phoneno = '';
    ...
    onClickSave: function () {
        if (Common.formValidator(this, this.state.provCorp)) {
            ...
            ProvCorpActions.createProvCorp(this.state.provCorp, this.props.provCorp);
        }
    },
    ...
    render: function () {
        ...
        return (
            <Modal visible={this.state.modal} width='540px' title="增加供应商" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                footer={[
                    <div key="footerDiv" style={{ display: 'block', textAlign: 'right' }}>
                        <ServiceMsg ref='mxgBox' svcList={['prov-corp/create']} />
...
export default CreateProvCorpPage;
