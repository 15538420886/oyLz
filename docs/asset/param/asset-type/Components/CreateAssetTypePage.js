...
var CreateAssetTypePage = React.createClass({
    ...
    clear : function(filter){
        this.state.hints = {};
        this.state.assetType.corpUuid = window.loginData.compUser.corpUuid;
        this.state.assetType.typeCode='';
        this.state.assetType.typeName='';
        this.state.assetType.assertClazz='';
        this.state.assetType.measuUnit='';
        this.state.assetType.depreYear='';
        this.state.assetType.depreType='';
        this.state.assetType.depreParam='';
        this.state.assetType.purchDept='';
        this.state.assetType.memo2='';
    ...
    onClickSave : function(){
        if(Common.formValidator(this, this.state.assetType)){
            ...
            AssetTypeActions.createAssetType( this.state.assetType, this.props.assertClazz);
        }
    },
        ...
        return (
            <div style={{overflow:'hidden', height:'100%', paddingLeft: '4px'}}>
                <Tabs defaultActiveKey="2"  onChange={this.onTabChange} tabBarStyle={{paddingLeft: '16px', margin: '-36px 0 0'}} style={{width: '100%', height: '100%', padding: '36px 0 0'}}>
                    ...
                    <TabPane tab="增加资产类别" key="2" style={{width: '100%', height: '100%'}}>
...
export default CreateAssetTypePage;