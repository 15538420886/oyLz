...
var CreateStorLocPage = React.createClass({
	...
	clear : function(corpUuid){
		this.state.hints = {};
		this.state.storLoc.uuid='';
		this.state.storLoc.corpUuid = window.loginData.compUser.corpUuid;
		this.state.storLoc.locName='';
		this.state.storLoc.storCity='';
		this.state.storLoc.storName='';
		this.state.storLoc.memo2='';
	...
	onSelectEmpLoyee:function(data){
        this.state.storLoc.userUuid = data.uuid;
		this.state.storLoc.staffCode = data.staffCode;
		this.state.storLoc.storName = data.perName;
	...
	onClickSave : function(){
		if(Common.formValidator(this, this.state.storLoc)){
			...
			StorLocActions.createStorLoc( this.state.storLoc );
		}
	},
	...
	render : function(){
        ...
        var boo = this.state.storLoc.userUuid? false : true ;
		...
		return (
			<div style={{overflow:'hidden', height:'100%', paddingLeft: '4px'}}>
				<Tabs defaultActiveKey="2"  onChange={this.onTabChange} tabBarStyle={{paddingLeft: '16px', margin: '-36px 0 0'}} style={{width: '100%', height: '100%', padding: '36px 0 0'}}>
					...
					<TabPane tab="增加库管地" key="2" style={{width: '100%', height: '100%',overflowY:'auto'}}>
...
export default CreateStorLocPage;
