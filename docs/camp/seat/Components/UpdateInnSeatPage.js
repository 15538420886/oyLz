...
var UpdateInnSeatPage = React.createClass({
	...
	onClickSave : function(){
		if(Validator.formValidator(this, this.state.seat)){
			...
			InnSeatActions.updateHrSeat( this.state.seat );
		}
	},
	onClickDelete: function(){
		this.setState({loading: true});
		InnSeatActions.deleteHrSeat( this.state.seat.uuid );
	},
...
export default UpdateInnSeatPage;
