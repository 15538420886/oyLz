...
var CreateSeatPage = React.createClass({
	...
	onClickSave : function(){
		if(Validator.formValidator(this, this.state.seat)){
			...
			SeatActions.createHrSeat( this.state.seat );
		}
	},
			...
			>
		   		<Form layout={layout}>
					...
					<FormItem {...formItemLayout} label="位置" colon={true} className={layoutItem}>
						<Col span="8">
							<FormItem className={layoutItem} help={hints.rowIndexHint} validateStatus={hints.rowIndexStatus}>
								<InputGroup compact>
									...
									<Input style={{ width:'65%',textAlign:'center'}} type="text" name="rowIndex" id="rowIndex" readOnly='true' value={this.state.seat.rowIndex} onChange={this.handleOnChange}/>
								</InputGroup>
							</FormItem>
						</Col>
						<Col span="3">
						...
						<Col span="8">
							<FormItem className={layoutItem} help={hints.colIndexHint} validateStatus={hints.colIndexStatus}>
								<InputGroup compact>
									<Input style={{ width:'35%',textAlign:'center'}} defaultValue="列" readOnly={true}/>
									<Input style={{ width:'65%',textAlign:'center'}} type="text" name="colIndex" id="colIndex" readOnly='true' value={this.state.seat.colIndex} onChange={this.handleOnChange}/>		
								</InputGroup>
							</FormItem>
						</Col>
					</FormItem>
