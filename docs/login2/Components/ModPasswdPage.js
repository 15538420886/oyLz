...
var ModPasswdPage = React.createClass({
        ...
        return (
            <div style={{ width: '100%' }}>
                <div style={{ width: '300px', paddingTop: '100px', margin: '0 auto' }}>
                    <div style={{ width: '100%', height: '40px', lineHeight: '40px', fontSize: '16px', textAlign: 'center', marginBottom: '10px', color: '#fff', opacity: '.9' }}>修改密码</div>
                    <Form layout={layout}>
                        ...
                        <FormItem {...formItemLayout} label="" colon={true} style={{ marginBottom: '20px' }} className={layoutItem} help={hints.newPasswdHint} validateStatus={hints.newPasswdStatus} >
                            <Input prefix={<Icon type="lock" style={{ fontSize: 13 }} />} placeholder="新密码" type="password" name="newPasswd" id="newPasswd" value={this.state.passwd.newPasswd} onChange={this.handleOnChange} />
                        </FormItem>
                        <FormItem {...formItemLayout} label="" colon={true} style={{ marginBottom: '20px' }} className={layoutItem} help={hints.confirmPadHint} validateStatus={hints.confirmPadStatus} >
                            <Input prefix={<Icon type="lock" style={{ fontSize: 13 }} />} placeholder="确认密码" type="password" name="confirmPad" id="confirmPad" value={this.state.passwd.confirmPad} onChange={this.handleOnChange} />
                        </FormItem>
                        <FormItem>
