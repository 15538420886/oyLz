...
var UpdateStdJobPage = React.createClass({
    ...
    componentDidMount: function () {
        ...
        this.initPage(this.props.stdJob);
    },

    initPage: function (stdJob) {
        this.state.hints = {};
        Utils.copyValue(stdJob, this.state.stdJob);
    ...
    onClickSave: function () {
        if (Common.formValidator(this, this.state.stdJob)) {
            ...
            StdJobActions.updateStdJob(this.state.stdJob);
        }
    },
        ...
        return (
            <div style={{ overflow: 'hidden', height: '100%', paddingLeft: '4px' }}>
                <Tabs defaultActiveKey="2" onChange={this.onTabChange} tabBarStyle={{ paddingLeft: '16px', margin: '-36px 0 0' }} style={{ width: '100%', height: '100%', padding: '36px 0 0' }}>
                    ...
                    <TabPane tab="修改标准岗位" key="2" style={{ width: '100%', height: '100%' }}>
                    ...
                    <TabPane tab="薪资范围" key="3" style={{ width: '100%', height: '100%' }}>
                        <JobSalaryPage stdJob={this.state.stdJob} />
                    </TabPane>
                </Tabs>
            </div>
        );
...
export default UpdateStdJobPage;