...
var CreateEntryLocPage = React.createClass({
    ...
    clear : function(filter){
        // FIXME 输入参数，对象初始化
        this.state.hints = {};
        this.state.entryLoc.uuid='';
        this.state.entryLoc.filter = filter;
        this.state.entryLoc.locName='';
        this.state.entryLoc.corpName='';
        this.state.entryLoc.corpPhone='';
        this.state.entryLoc.cityName='';
        this.state.entryLoc.workTime='9:00-12:00,13:00-18:00';
        this.state.entryLoc.corpHome='';
    ...
    onClickSave : function(){
        if(Common.formValidator(this, this.state.entryLoc)){
            ...
            this.state.entryLoc.corpUuid = window.loginData.compUser.corpUuid;
            EntryLocActions.createEntryLoc( this.state.entryLoc );
        }
    },
    ...
    render : function(){
        ...
        return (
            <Modal visible={this.state.modal} width='540px' title="增加入职地址信息" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                   footer={[
                       <div key="footerDiv" style={{display:'block', textAlign:'right'}}>
                           <ServiceMsg ref='mxgBox' svcList={['entry-loc/create']}/>
...
export default CreateEntryLocPage;