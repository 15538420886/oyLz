...
var TestQuestStore = require('../data/TestQuestStore');
var TestQuestActions = require('../action/TestQuestActions');

var CreateTestQuestPage = React.createClass({
    ...
    clear : function(filter){
        // FIXME 输入参数，对象初始化
        this.state.hints = {};
        this.state.questStore.uuid='';
        this.state.questStore.filter = filter;
        this.state.questStore.cateName='';
        this.state.questStore.cateLevel='中';
        this.state.questStore.cateType='笔试';
        this.state.questStore.cateMemo='';
        this.state.questStore.category='';
        this.state.questStore.cateMaker='';
        this.state.questStore.cateTime='';
    ...
    onClickSave : function(){
        if(Common.formValidator(this, this.state.questStore)){
            ...
            this.state.questStore.corpUuid = window.loginData.compUser.corpUuid;
            TestQuestActions.createQuestStore( this.state.questStore );
        }
    },
    ...
    render : function(){
        ...
        return (
            <Modal visible={this.state.modal} width='590px' title="增加面试题库" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                   footer={[
                       <div key="footerDiv" style={{display:'block', textAlign:'right'}}>
                           <ServiceMsg ref='mxgBox' svcList={['quest-store/create']}/>
...
export default CreateTestQuestPage;