...
import ProsNoticePage from './ProsNoticePage';
import HandleProsPage from './HandleProsPage';
import DeptTreeSelect from '../../../hr/lib/Components/DeptTreeSelect';
import CreateUserPage from '../../../hr/employee/Components/CreateUserPage';
...
var UpdateProsStaffPage = React.createClass({
    ...
    onClickSave: function () {
        if (Common.formValidator(this, this.state.prosStaff)) {
            ...
            ProsStaffActions.updateProsStaff(this.state.prosStaff);
        }
    ...
    render: function () {
        ...
        var contentTable = <div style={{ overflow: 'hidden', height: '100%', paddingLeft: '4px' }}>
                <Tabs defaultActiveKey="2" onChange={this.onTabChange} tabBarStyle={{ paddingLeft: '16px', margin: '-36px 0 0' }} style={{ width: '100%', height: '100%', padding: '36px 0 0' }}>
                    <TabPane tab="返回" key="1" style={{ width: '100%', height: '100%' }}>
                    </TabPane>
                    <TabPane tab="修改待入职人员信息" key="2" style={{ width: '100%', height: '100%' }}>
                    ...
                    <TabPane tab="入职通知" key="3" style={{ width: '100%', height: '100%' }}>
                        <div style={{ padding: "24px 0 16px 8px", height: '100%', overflowY: 'auto' }}>
                            <ProsNoticePage prosStaff={this.props.prosStaff} onBack={this.goBack} />
                        </div>
                    </TabPane>
                    <TabPane tab="办理入职" key="4" style={{ width: '100%', height: '100%' }}>
                         <HandleProsPage prosStaff={this.props.prosStaff} onBack={this.goBack} funcCreateUser={this.nextCreateUser}/>
                    </TabPane>
                </Tabs>
        </div>;
        return (
...
export default UpdateProsStaffPage;
