...
import EmpJobPage from '../../../hr/employee/Components/EmpJobPage';

var EmployeeStore = require('../../../hr/employee/data/EmployeeStore.js');
var EmployeeActions = require('../../../hr/employee/action/EmployeeActions');
import SearchStaffCodePage from '../../../hr/employee/Components/SearchStaffCodePage';
...
var CreateEmployeePage = React.createClass({
    ...
    initPage: function (prosStaff) {
        this.state.hints = {};
        Utils.copyValue(prosStaff, this.state.employee);
        this.setState({
            loading: false
        });

        this.state.employee.phoneno = prosStaff.phone;
        this.state.employee.entryDate = prosStaff.expectDate;
        this.state.employee.jobTitle = prosStaff.jobName;
    ...
    onClickSave: function () {
        ...
        if (Validator.formValidator(this, this.state.employee) && this.refs.jobPage.checkValue()) {
            ...
            empJob.deptName = employee.deptUuid;
            empJob.approver = '';
