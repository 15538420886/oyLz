...
var CreateTripAgentPage = React.createClass({
    ...
    componentDidMount : function(){
        this.state.validRules = [
            ...
            { id: 'phone', desc: '代办点电话', max: 24,},
            { id: 'account', desc: '客户经理', max: 64,},
            { id: 'mobile', desc: '电话', max: 24,},
            { id: 'location', desc: '地址', max: 128,},
    ...
    clear : function(filter){
        // FIXME 输入参数，对象初始化
        this.state.hints = {};
        this.state.tripAgent.uuid='';
        this.state.tripAgent.filter = filter;
        this.state.tripAgent.agentName='';
        this.state.tripAgent.city='';
        this.state.tripAgent.phone='';
        this.state.tripAgent.account='';
        this.state.tripAgent.mobile='';
        this.state.tripAgent.location='';
        this.state.tripAgent.memo2='';
    ...
    onClickSave : function(){
        if(Common.formValidator(this, this.state.tripAgent)){
            ...
            this.state.tripAgent.corpUuid= window.loginData.compUser.corpUuid;
            TripAgentActions.createTripAgent( this.state.tripAgent );
        }
    },
    ...
    render : function(){
        ...
        return (
            <Modal visible={this.state.modal} width='540px' title="增加机票代理点" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                   footer={[
                       <div key="footerDiv" style={{display:'block', textAlign:'right'}}>
                           <ServiceMsg ref='mxgBox' svcList={['trip-agent/create']}/>
...
export default CreateTripAgentPage;