...
var CreateSystemPage = React.createClass({
...
//          BmCompanyActions.retrieveTmCase(filter);
    ...
    onClickSave: function () {
        if (Validator.validator(this, this.state.companyListSet)) {
            ...
            BmSystemActions.createBmSystem(this.state.companyListSet);
             this.setState({
        ...
        var form =
            <Form layout={layout}>
                <Row>
                    <Col span={12}>
					    <FormItem {...formItemLayout2} label="系统编码" required={true} colon={true} className={layoutItem} help={hints.sysCodeHint} validateStatus={hints.sysCodeStatus}>
							<Input type="text" name="sysCode" id="sysCode" value={this.state.companyListSet.sysCode } onChange={this.handleOnChange} />
						</FormItem>
					</Col>
				    <Col span={12}>
						<FormItem {...formItemLayout2} label="公司简称" required={true} colon={true} className={layoutItem} help={hints.rsvStr1Hint} validateStatus={hints.rsvStr1Status}>
							<Input type="text" name="rsvStr1" id="rsvStr1" value={this.state.companyListSet.rsvStr1 } onChange={this.handleOnChange} />
						</FormItem>
					</Col>
				</Row>
				<Row>
                    <Col span={12}>
						<FormItem {...formItemLayout2} label="开发负责人" required={false} colon={true} className={layoutItem} help={hints.sysDevmanagerHint} validateStatus={hints.sysDevmanagerStatus}>
							<Input type="text" name="sysDevmanager" id="sysDevmanager" value={this.state.companyListSet.sysDevmanager } onChange={this.handleOnChange} />
						</FormItem>
					</Col>
				    <Col span={12}>
						<FormItem {...formItemLayout2} label="测试负责人" required={false} colon={true} className={layoutItem} help={hints.sysTestmanagerHint} validateStatus={hints.sysTestmanagerStatus}>
							<Input type="text" name="sysTestmanager" id="sysTestmanager" value={this.state.companyListSet.sysTestmanager } onChange={this.handleOnChange} />
				    	</FormItem>
					</Col>
				</Row>
				...
				<FormItem {...formItemLayout} label="系统名称" required={true} colon={true} className={layoutItem} help={hints.sysNameHint} validateStatus={hints.sysNameStatus}>
					<Input type="text" name="sysName" id="sysName" value={this.state.companyListSet.sysName } onChange={this.handleOnChange} />
				</FormItem>
				<FormItem {...formItemLayout} label="所属部门UUID" required={false} colon={true} className={layoutItem} help={hints.orgIdHint} validateStatus={hints.orgIdStatus}>
					<Input type="text" name="orgId" id="orgId" value={this.state.companyListSet.orgId } onChange={this.handleOnChange} />
				</FormItem>
				<FormItem {...formItemLayout} label="最新版本号" required={false} colon={true} className={layoutItem} help={hints.sysVersionHint} validateStatus={hints.sysVersionStatus}>
					<Input type="text" name="sysVersion" id="sysVersion" value={this.state.companyListSet.sysVersion } onChange={this.handleOnChange} />
				</FormItem>
				<FormItem {...formItemLayout} label="备注" required={false} colon={true} className={layoutItem} help={hints.remarkHint} validateStatus={hints.remarkStatus}>
					<Input type="text" name="remark" id="remark" value={this.state.companyListSet.remark } onChange={this.handleOnChange} />
				</FormItem>
				<FormItem>		     
				       <Dragger {...props}>
