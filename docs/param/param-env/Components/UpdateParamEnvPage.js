...
var UpdateParamEnvPage = React.createClass({
  ...
  initPage: function(paramEnv){
        this.state.hints = {};
        Utils.copyValue(paramEnv, this.state.paramEnv);
  ...
  onClickSave : function(){
      if(Validator.formValidator(this, this.state.paramEnv)){
        ...
        ParamEnvActions.updateParamEnv(this.state.paramEnv)
      }
  },
  ...
  render : function() {
    ...
    return (
        <Modal visible={this.state.modal} width='540px' title="修改系统环境信息" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
          footer={[
...
export default UpdateParamEnvPage;
