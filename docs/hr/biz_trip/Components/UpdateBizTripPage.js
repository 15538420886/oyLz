...
var UpdateBizTripPage = React.createClass({
	...
	initPage: function(bizTrip)
	{
		this.state.hints = {};
		Utils.copyValue(bizTrip, this.state.bizTrip);
	...
	onClickSave : function(){
		if(Validator.formValidator(this, this.state.bizTrip)){
			...
			BizTripActions.updateHrBizTrip( this.state.bizTrip );
		}
	},
	...
	render : function() {
		...
		return (
			<Modal visible={this.state.modal} width='540px' title="修改差旅级别信息" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
			  footer={[
			  	<div key="footerDiv" style={{display:'block', textAlign:'right'}}>
					<ServiceMsg ref='mxgBox' svcList={['hr_biz_trip/update']}/>
...
export default UpdateBizTripPage;
