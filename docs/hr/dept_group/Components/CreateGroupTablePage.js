...
var CreateGroupTablePage = React.createClass({
	...
	clear : function(corpUuid){
		...
		this.state.group.groupCode='';
		this.state.group.groupDesc='';
		this.state.group.groupLoc='';
		this.state.group.uuid='';
		this.state.group.corpUuid = corpUuid;
	...
	onClickSave : function(){
		if(Validator.formValidator(this, this.state.group)){
			...
			GroupTableActions.createHrDeptGroup( this.state.group );
		}
	},
	...
	render : function(){
		...
		return (
			<Modal visible={this.state.modal} width='540px' title="增加事业群" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
			  footer={[
			  	<div key="footerDiv" style={{display:'block', textAlign:'right'}}>
					<ServiceMsg ref='mxgBox' svcList={['hr_dept_group/create']}/>
...
export default CreateGroupTablePage;
