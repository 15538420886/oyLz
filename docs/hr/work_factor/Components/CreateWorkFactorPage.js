...
var CreateWorkFactorPage = React.createClass({
	...
	clear : function(corpUuid , workUuid){
		this.state.hints = {};
		this.state.workFactor.uuid='';
		this.state.workFactor.workUuid = workUuid;
		this.state.workFactor.corpUuid = corpUuid;
		this.state.workFactor.kpiName='';
		this.state.workFactor.kpiWeight='';
		this.state.workFactor.kpiValues='';
		this.state.workFactor.kpiDesc='';
	...
	onClickSave : function(){
		if(Validator.formValidator(this, this.state.workFactor)){
			...
			WorkFactorActions.createHrWorkFactor( this.state.workFactor );
		}
	},
...
export default CreateWorkFactorPage;
