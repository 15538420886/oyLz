...
var BatchJobPage = React.createClass({
    ...
    mixins: [Reflux.listenTo(JobStore, "onServiceComplete")],
    ...
    render: function () {
        ...
        var jobName = record ? record.jobName : '';
        ...
        if (this.state.stop) {
            ...
            text = jobName ? <span>正在生成 {jobName} ……</span> : <span>已完成！</span>;
        }
        return (
