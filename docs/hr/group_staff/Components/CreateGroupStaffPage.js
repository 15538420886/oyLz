...
var CreategroupStaffPage = React.createClass({
    ...
    clear: function (corpUuid, groupUuid) {
        this.state.hints = {};
        this.state.staff.perName = '';
        this.state.staff.jobTitle = '';
        this.state.staff.phoneno = '';
        this.state.staff.email = '';
        this.state.staff.jobDesc = '';
        this.state.staff.uuid = '';
        this.state.staff.groupUuid = groupUuid;
        this.state.staff.corpUuid = corpUuid;
    ...
    onClickSave: function () {
        if (Validator.formValidator(this, this.state.staff)) {
            ...
            GroupStaffActions.createHrGroupStaff(this.state.staff);
        }
    },
    ...
    onSelectEmpLoyee: function (data) {
        this.state.staff.jobTitle = data.jobTitle;
        this.state.staff.perName = data.perName;
        this.state.staff.phoneno = data.phoneno;
        this.state.staff.email = data.email;
            ...
            <Modal visible={this.state.modal} width='540px' title="增加人员" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                footer={[
                    <div key="footerDiv" style={{ display: 'block', textAlign: 'right' }}>
                        <ServiceMsg ref='mxgBox' svcList={['hr-group-staff/create']} />
...
export default CreategroupStaffPage;
