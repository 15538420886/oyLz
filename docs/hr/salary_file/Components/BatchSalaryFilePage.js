...
var SalaryFileStore = require('../data/SalaryFileStore');
var SalaryFileActions = require('../action/SalaryFileActions');

var BatchSalaryFilePage = React.createClass({
    ...
    mixins: [Reflux.listenTo(SalaryFileStore, "onServiceComplete")],
    ...
    doBatchCreate: function (recordList) {
        ...
        SalaryFileActions.createHrSalaryFileItem(record);
    },
    ...
    render: function () {
        ...
        var colIndex = record ? record.colIndex : '';
        ...
        if (this.state.stop) {
            ...
            text = colIndex ? <span>正在生成 {colIndex} ……</span> : <span>已完成！</span>;
        }
        return (
...
export default BatchSalaryFilePage;
