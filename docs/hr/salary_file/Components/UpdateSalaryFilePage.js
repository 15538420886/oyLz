...
var UpdateSalaryFilePage = React.createClass({
	...
	initPage: function(salaryFile)
	{
		this.state.hints = {};
		Utils.copyValue(salaryFile, this.state.salaryFile);
	...
	onClickSave : function(){
		if(Common.formValidator(this, this.state.salaryFile)){
			...
			SalaryFileActions.updateHrSalaryFileItem( this.state.salaryFile );
		}
	},
	...
	render : function() {
		...
		return (
			<Modal visible={this.state.modal} width='540px' title="修改工资单信息" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
			  footer={[
			  	<div key="footerDiv" style={{display:'block', textAlign:'right'}}>
					<ServiceMsg ref='mxgBox' svcList={['hr_salary_file_item/update']}/>
...
export default UpdateSalaryFilePage;
