...
var BatchWorkTypePage = React.createClass({
    ...
    mixins: [Reflux.listenTo(WorkTypeStore, "onServiceComplete")],
    ...
    doBatchCreate: function (recordList) {
        ...
        WorkTypeActions.createHrWorkType(record );
    },
    ...
    render: function () {
        ...
        var workName = record ? record.workName : '';
        ...
        if (this.state.stop) {
            ...
            text = workName ? <span>正在生成 {workName} ……</span> : <span>已完成！</span>;
        }
        return (
...
export default BatchWorkTypePage;
