...
var EmpJobStore = Reflux.createStore({
	...
	fireEvent: function(operation, errMsg, self)
	{
		...
		MsgActions.showError('p_emp_job', operation, errMsg);
	},

	onRetrievePersonEmpJob: function(filter) {
		var self = this;
		var url = this.getServiceUrl('hr_emp_job/get-by-user_uuid');
