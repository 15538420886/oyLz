...
var CreateTripCityPage = React.createClass({
	...
	clear : function(corpUuid){
		this.state.hints = {};
		this.state.tripCity.uuid='';
		this.state.tripCity.corpUuid = corpUuid;
		this.state.tripCity.cityType='';
		this.state.tripCity.cityList='';
		this.state.tripCity.cityDesc='';
	...
	onClickSave : function(){
		if(Validator.formValidator(this, this.state.tripCity)){
			...
			TripCityActions.createHrTripCity( this.state.tripCity );
		}
	},
	...
	render : function(){
		...
		return (
			<Modal visible={this.state.modal} width='540px' title="增加城市" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
			  footer={[
			  	<div key="footerDiv" style={{display:'block', textAlign:'right'}}>
					<ServiceMsg ref='mxgBox' svcList={['hr_trip_city/create']}/>
...
export default CreateTripCityPage;
