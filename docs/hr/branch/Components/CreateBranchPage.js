...
var CreateBranchPage = React.createClass({
    ...
    componentDidMount: function () {
        this.state.validRules = [
            ...
            { id: 'branchDesc', desc: '公司描述', required: false, max: '512' },
    ...
    clear: function (corpUuid) {
        ...
        this.state.hints = {};
        this.state.branch.uuid = '';
        this.state.branch.corpUuid = corpUuid;
        this.state.branch.branchName = '';
        this.state.branch.branchCity = '';
        this.state.branch.branchLoc = '';
        this.state.branch.branchCode = '';
        this.state.branch.branchPhone = '';
        this.state.branch.branchDesc = '';
        this.state.branch.branchType = '全资子公司';
    ...
    onClickSave: function () {
        if (Validator.formValidator(this, this.state.branch)) {
            ...
            BranchActions.createHrBranch(this.state.branch);
        }
    },
    ...
    render: function () {
        ...
        return (
            <Modal visible={this.state.modal} width='640px' title="增加分公司" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                footer={[
                    <div key="footerDiv" style={{ display: 'block', textAlign: 'right' }}>
                        <ServiceMsg ref='mxgBox' svcList={['hr_branch/create']} />
