...
var CreateDeptStaffPage = React.createClass({
    ...
    clear: function (corpUuid, deptUuid) {
        this.state.hints = {};
        this.state.deptStaff.perName = '';
        this.state.deptStaff.jobTitle = '';
        this.state.deptStaff.phoneno = '';
        this.state.deptStaff.email = '';
        this.state.deptStaff.jobDesc = '';
        this.state.deptStaff.uuid = '';
        this.state.deptStaff.corpUuid = corpUuid;
        this.state.deptStaff.deptUuid = deptUuid;
    ...
    onClickSave: function () {
        if (Validator.formValidator(this, this.state.deptStaff)) {
            ...
            // console.log("this.state.deptStaff", this.state.deptStaff);
            DeptStaffActions.createHrDeptStaff(this.state.deptStaff);
        }
    },
    ...
    onSelectEmpLoyee: function (data) {
        this.state.deptStaff.jobTitle = data.jobTitle;
        this.state.deptStaff.perName = data.perName;
        this.state.deptStaff.phoneno = data.phoneno;
        this.state.deptStaff.email = data.email;
            ...
            <Modal visible={this.state.modal} width='540px' title="增加人员" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                footer={[
                    <div key="footerDiv" style={{ display: 'block', textAlign: 'right' }}>
                        <ServiceMsg ref='mxgBox' svcList={['hr-dept-staff/create']} />
            ...
            >
                ...
                <Form layout={layout}>
                    ...
                    <FormItem {...formItemLayout} label="电子邮箱" required={false} colon={true} className={layoutItem} help={hints.emailHint} validateStatus={hints.emailStatus}>
                        <AutoComplete name="email" id="email" value={this.state.deptStaff.email} onSearch={this.handleSearch} placeholder="请输入电子邮箱" onChange={this.emailOnChange} >
                            {children}
                        </AutoComplete>
                    </FormItem>
...
export default CreateDeptStaffPage;
