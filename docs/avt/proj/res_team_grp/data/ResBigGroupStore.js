...
var ResBigGroupStore = Reflux.createStore({
	listenables: [ResBigGroupActions],
	...
	onCreateResTeamGrp: function(resGroupMan) {
		var url = this.getServiceUrl('res-team-grp/create');
		Utils.recordCreate(this, resGroupMan, url);
	},
	
	onUpdateResTeamGrp: function(resGroupMan) {
		var url = this.getServiceUrl('res-team-grp/update');
		Utils.recordUpdate(this, resGroupMan, url);
	},
	
	onDeleteResTeamGrp: function(uuid) {
		var url = this.getServiceUrl('res-team-grp/remove');
		Utils.recordDelete(this, uuid, url);
	}
});

module.exports = ResBigGroupStore;
