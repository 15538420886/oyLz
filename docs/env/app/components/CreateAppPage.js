...
var CreateAppPage = React.createClass({
	...
	clear : function(){
		...
		this.state.app.appCode='';
		this.state.app.appDesc='';
		this.state.app.appType='';
		this.state.app.appGroup='';
		this.state.app.fileName='';
		this.state.app.springName='';
		this.state.app.configName='';
		this.state.app.memo2='';
