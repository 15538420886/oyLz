...
var UpdateFntModPage = React.createClass({
    ...
    initPage: function (fntMod) {
        this.state.hints = {};
        Utils.copyValue(fntMod, this.state.fntMod);
    ...
    onClickSave: function () {
        if (Validator.formValidator(this, this.state.fntMod)) {
            ...
            FntModActions.updateFntAppMod(this.state.fntMod);
        }
    },
    ...
    render: function () {
        ...
        return (
            <Modal visible={this.state.modal} width='540px' title="修改模块" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                footer={[
                    <div key="footerDiv" style={{ display: 'block', textAlign: 'right' }}>
                        <ServiceMsg ref='mxgBox' svcList={['/fnt_app_mod/update']} />
...
export default UpdateFntModPage;
