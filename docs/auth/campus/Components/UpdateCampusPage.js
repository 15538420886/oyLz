...
var UpdateCampusPage = React.createClass({
    ...
    initPage: function(campus)
    {
        this.state.hints = {};
        Utils.copyValue(campus, this.state.campus);
  ...
  onClickSave : function(){
      if(Validator.formValidator(this, this.state.campus)){
          ...
          CampusActions.updateAuthCampus( this.state.campus );
      }
  },
  ...
  render : function() {
    ...
    return (
      <Modal visible={this.state.modal} width='540px' title="修改园区信息" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
        footer={[
          <div key="footerDiv" style={{display:'block', textAlign:'right'}}>
            <ServiceMsg ref='mxgBox' svcList={['auth-campus/update']}/>
...
export default UpdateCampusPage;
