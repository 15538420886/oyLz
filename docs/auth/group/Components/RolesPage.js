...
import RoleListPage from '../../roles/Components/RoleListPage'
...
var RolesPage = React.createClass({
    ...
    componentDidMount : function(){
        ...
        RoleActions.initGroupRoleInfo(this.props.appGroup.uuid);
    },
    ...
    render : function() {
        ...
        return (
            <div className='grid-page'>
                <ServiceMsg ref='mxgBox' svcList={['auth-app-role-group/retrieve', 'auth-app-role-group/remove', 'auth-app-role-group/update', 'auth-app-role/groupRoles']}/>

                <RoleListPage ref='modList' width='220px' onSelectRoles={this.onSelectRoles} appUuid={this.props.appGroup.uuid}>
