...
var UpdateOrderItemPage = React.createClass({
    ...
    initPage: function (orderItem) {
        this.state.hints = {};
        Utils.copyValue(orderItem, this.state.orderItem);
    ...
    onClickSave: function () {
        if (Common.formValidator(this, this.state.orderItem)) {
            ...
            OrderItemActions.updateOrderItem(this.state.orderItem);
        }
    },
    ...
    render: function () {
        ...
        return (
            <Modal visible={this.state.modal} width='700px' title="修改任务信息信息" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                footer={[
                    <div key="footerDiv" style={{ display: 'block', textAlign: 'right' }}>
                        <ServiceMsg ref='mxgBox' svcList={['order_item/update']} />
