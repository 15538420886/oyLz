...
var CreateOrderDiscPage = React.createClass({
    ...
    clear: function (orderUuid) {
        this.state.hints = {};
        this.state.orderDisc.uuid = '';
        this.state.orderDisc.corpUuid = window.loginData.compUser.corpUuid;
        this.state.orderDisc.orderUuid = orderUuid;
        this.state.orderDisc.disDate = '';
        this.state.orderDisc.discount = '';
        this.state.orderDisc.approver = '';
        this.state.orderDisc.discReason = '';
    ...
    onClickSave: function () {
        if (Common.formValidator(this, this.state.orderDisc)) {
            ...
            OrderDiscActions.createOrderDisc(this.state.orderDisc);
        }
    },
    ...
    render: function () {
        ...
        return (
            <Modal visible={this.state.modal} width='540px' title="增加折让信息" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
                footer={[
                    <div key="footerDiv" style={{ display: 'block', textAlign: 'right' }}>
                        <ServiceMsg ref='mxgBox' svcList={['order-disc/create']} />
...
export default CreateOrderDiscPage;