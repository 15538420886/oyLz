...
var ResMemberSmallStore = require('./../data/ResMemberSmallStore');
var ResMemberSmallActions = require('./../action/ResMemberSmallActions');

var ResMemberSmallPage = React.createClass({
    ...
    mixins: [Reflux.listenTo(ResMemberSmallStore, "onServiceComplete")],
    ...
    componentDidMount : function(){
        ...
        filter.groupUuid = this.props.resTeam.uuid;
        ResMemberSmallActions.retrieveResMemberSmall(filter);
    },
...
module.exports = ResMemberSmallPage;