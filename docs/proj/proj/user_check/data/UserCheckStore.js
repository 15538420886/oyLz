...
var UserCheckStore = Reflux.createStore({
    listenables: [UserCheckActions],
    ...
    onRetrieveUserChkBook: function (filter) {
        var self = this;
        var url = this.getServiceUrl('user-chk-book/retrieve2');
    ...
    onCreateUserChkBook: function (UserCheck) {
        var url = this.getServiceUrl('user-chk-book/create');
        Utils.recordCreate(this, UserCheck, url, this.onCreateComplete);
    },
    ...
    onUpdateUserChkBook: function (data) {
        ...
        var url = this.getServiceUrl('user-chk-book/update');
    ...
    onDeleteUserChkBook: function (userChkObj) {
        var url = this.getServiceUrl('res-member-snap/delete-chk-book');
