...
var MemberLogStore = Reflux.createStore({
	listenables: [MemberLogActions],
	...
	onCreateProjMember: function(memberLog) {
		var url = this.getServiceUrl('proj-member/create');
		Utils.recordCreate(this, memberLog, url);
	},
	
	onUpdateProjMember: function(memberLog) {
		var url = this.getServiceUrl('proj-member/update');
		Utils.recordUpdate(this, memberLog, url);
	},
