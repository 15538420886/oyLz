...
var MemberLogFilter = React.createClass({
                        ...
                        <Row style={{textAlign:'right'}}>
                            ...
                            <Col span="8">
                                <FormItem {...formItemLayout} label="姓名" required={false} colon={true} className={layoutItem} help={hints.perNameHint} validateStatus={hints.perNameStatus}>
                                    <Input type="text" name="perName" id="perName" value={this.state.memberLog.perName } onChange={this.handleOnChange} />
                                </FormItem>
                            </Col>
                            <Col span="8">
                                <FormItem {...formItemLayout} label="员工号" required={false} colon={true} className={layoutItem} help={hints.staffCodeHint} validateStatus={hints.staffCodeStatus}>
                                    <Input type="text" name="staffCode" id="staffCode" value={this.state.memberLog.staffCode } onChange={this.handleOnChange} />
                                </FormItem>
                            </Col>
						</Row>
						<Col span="8">
                            <FormItem {...formItemLayout} label="小组" required={false} colon={true} className={layoutItem} help={hints.teamUuidHint} validateStatus={hints.teamUuidStatus}>
                                <SelectProjTeam projUuid={projUuid} name="teamUuid" id="teamUuid" value={this.state.memberLog.teamUuid} onSelect={this.handleOnSelected.bind(this, "teamUuid")}/>
                            </FormItem>
						</Col>
						<Col span="8">
                            <FormItem {...formItemLayout} label="状态" required={false} colon={true} className={layoutItem} help={hints.manStatusHint} validateStatus={hints.manStatusStatus}>
                                <DictSelect name="manStatus" id="manStatus" value={this.state.memberLog.manStatus } appName='项目管理' optName='项目组人员状态' onSelect={this.handleOnSelected.bind(this, "manStatus")}/>
                            </FormItem>
						</Col>
						<Col span="8">
                            <FormItem {...formItemLayout} label="离组日期" required={false} colon={true} className={layoutItem} help={hints.endDateHint} validateStatus={hints.endDateStatus}>
                                <DatePicker style={{width:'100%'}} name="endDate" id="endDate"  value={this.formatDate(this.state.memberLog.endDate, Common.dateFormat)}  format={Common.dateFormat} onChange={this.handleOnSelDate.bind(this,"endDate", Common.dateFormat)}/>
                            </FormItem>
						</Col>
					</Form>
				</div>
...
module.exports = MemberLogFilter;
