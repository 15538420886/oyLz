...
var UpdateTempMemberPage = React.createClass({
	...
	initPage: function(tempMember)
	{
		...
		this.state.tempMember.oldteamUuid = this.state.tempMember.teamUuid;
	...
	render : function() {
        ...
        var teamName = this.getTeamName(projUuid, this.state.tempMember.oldteamUuid);
...
export default UpdateTempMemberPage;
