...
import SearchTempProjMember from '../../../lib/Components/SearchTempProjMember';
...
var CreateProjTempMemberPage = React.createClass({
	...
	render : function(){
		...
		return (
			<Modal visible={this.state.modal} width='540px' title="增加临时人员" maskClosable={false} onOk={this.onClickSave} onCancel={this.toggle}
			  footer={[
			...
			>
		   		<Form layout={layout}>
                    <div style={{borderBottom:'1px solid #ccc',marginBottom:'16px'}}>
                        <SearchTempProjMember style={{width:'400px',margin:'0 0 15px 22px'}} projUuid={projUuid} showError={this.showError} onSelectMember={this.onSelectProjTask}/>
                    </div>
                    <Row>
                        <Col span="12">
...
export default CreateProjTempMemberPage;
