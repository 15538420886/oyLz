...
var CreateProjTeamPage = React.createClass({
	...
	clear : function(projUuid){
		this.state.hints = {};
		this.state.projTeam.uuid='';
		this.state.projTeam.projUuid =  ProjContext.selectedProj.uuid;
		this.state.projTeam.corpUuid = window.loginData.compUser.corpUuid;
		this.state.projTeam.teamName = '';

		this.state.projTeam.teamCode='';
		this.state.projTeam.tmName='';
		this.state.projTeam.teamDesc='';
		this.state.projTeam.projScope='';
		this.state.projTeam.techDesc='';
	...
	onClickSave : function(){
		...
		ProjTeamActions.createProjTeam( this.state.projTeam );
	},
	...
	render : function(){
        ...
        var boo = this.state.projTeam.teamCode? false : true ;
				...
				<Tabs defaultActiveKey="2"  onChange={this.onTabChange} tabBarStyle={{paddingLeft: '16px', margin: '-36px 0 0'}} style={{width: '100%', height: '100%', padding: '36px 0 0'}}>
					...
					<TabPane tab="增加小组" key="2" style={{width: '100%', height: '100%'}}>
                        <div style={{padding:"20px 0 16px 8px", height: '100%',overflowY: 'auto'}}>
			            	<ServiceMsg ref='mxgBox' svcList={['proj_team/create']}/>
...
module.exports = CreateProjTeamPage;
