...
var BiziProjFilter = React.createClass({
	...
	componentDidMount : function(){
		this.state.validRules = [
            ...
            {id: 'projType', desc:'项目类型:培训、会议、商务活动', required: false, max: '64'},
		];
	},
                        ...
                        <Row  gutter={24}>
                            <Col className="gutter-row" span={8}>
                                <FormItem {...formItemLayout2} label="项目名称" required={false} colon={true} className={layoutItem} help={hints.projNameHint} validateStatus={hints.projNameStatus}>
                                    <Input type="text" name="projName" id="projName" value={this.state.biziProj.projName } onChange={this.handleOnChange} />
                                </FormItem>
                            </Col>
                            <Col className="gutter-row" span={8}>
                                <FormItem {...formItemLayout2} label="项目编号" required={false} colon={true} className={layoutItem} help={hints.projCodeHint} validateStatus={hints.projCodeStatus}>
                                    <Input type="text" name="projCode" id="projCode" value={this.state.biziProj.projCode } onChange={this.handleOnChange} />
                                </FormItem>
                            </Col>
                            <Col className="gutter-row" span={8}>
                                <FormItem {...formItemLayout} label="开始月份" required={false} colon={true} className={layoutItem} help={hints.beginDateHint} validateStatus={hints.beginDateStatus}>
                                    <MonthPicker  style={{width:'100%'}}  name="beginDate" id="beginDate"  format={Common.monthFormat} value={this.formatMonth(this.state.biziProj.beginDate, Common.monthFormat)} onChange={this.handleOnSelDate.bind(this,"beginDate", Common.monthFormat)}/>
                                </FormItem>
                            </Col>
                        </Row>
                        <Row  gutter={24}>
                            ...
                            <Col className="gutter-row" span={8}>
                                <FormItem {...formItemLayout2} label="主办方" required={false} colon={true} className={layoutItem} help={hints.projHostHint} validateStatus={hints.projHostStatus}>
                                   <Input type="text" name="projHost" id="projHost" value={this.state.biziProj.projHost } onChange={this.handleOnChange} />
                                </FormItem>
                            </Col>
                            <Col className="gutter-row" span={8}>
                                <FormItem {...formItemLayout} label="所在城市" required={false} colon={true} className={layoutItem} help={hints.projLocHint} validateStatus={hints.projLocStatus}>
...
BiziProjFilter.propTypes = propTypes;
module.exports = BiziProjFilter;
