...
var CreateBiziProjPage = React.createClass({
	...
	clear : function(corpUuid){
		this.state.hints = {};
		this.state.biziPuuid='';
		this.state.biziProj.corpUuid = window.loginData.compUser.corpUuid;
		this.state.biziProj.custUuid='';
		this.state.biziProj.projCode='';
		this.state.biziProj.projName='';
		this.state.biziProj.beginDate='';
		this.state.biziProj.projLevel='';
		this.state.biziProj.projHost='';
		this.state.biziProj.projType='';
		this.state.biziProj.projFund='';
		this.state.biziProj.projLoc='';
		this.state.biziProj.endDate='';
		this.state.biziProj.pmName='';
		this.state.biziProj.projDesc='';
		this.state.biziProj.projAim='';
    ...
    onClickSave: function () {
        if (Common.formValidator(this, this.state.biziProj)) {
            ...
            BiziProjActions.createBiziProjInfo(this.state.biziProj);
        }
	},
	...
	render : function(){
        ...
        var boo = this.state.biziProj.projCode? false : true ;
		...
		return (
			<div style={{overflow:'hidden', height:'100%', paddingLeft: '4px'}}>
				<Tabs defaultActiveKey="2"  onChange={this.onTabChange} tabBarStyle={{paddingLeft: '16px', margin: '-36px 0 0'}} style={{width: '100%', height: '100%', padding: '36px 0 0'}}>
					...
					<TabPane tab="增加项目" key="2" style={{width: '100%', height: '100%',overflowY:'auto'}}>
                        <div style={{padding:"20px 0 16px 8px", height: '100%',overflowY: 'auto'}}>
			            	<ServiceMsg ref='mxgBox' svcList={['bizi-proj/create']}/>
								...
								<Row>
									<Col span="12">
										<FormItem {...formItemLayout2} label="项目经理" required={false} colon={true} className={layoutItem} help={hints.pmNameHint} validateStatus={hints.pmNameStatus}>
											<SearchResMember corpUuid={corpUuid} showError={this.showError} ref='empSearchBox'  type="text"  name="pmName" id="pmName" value={this.state.biziProj.pmName} onSelectMember={this.onSelectProj}/>
										</FormItem>
									</Col>
									<Col span="12">
...
module.exports = CreateBiziProjPage;
