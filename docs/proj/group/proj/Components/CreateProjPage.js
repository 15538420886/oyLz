...
import { Form, Modal, Button, Input, Select, Tabs, Row, Col, DatePicker, Checkbox } from 'antd';
...
var CreateProjPage = React.createClass({
	...
	clear : function(corpUuid){
		this.state.hints = {};
		this.state.proj.uuid='';
        this.state.proj.corpUuid = window.loginData.compUser.corpUuid;
        this.state.proj.parentUuid = ProjContext.selectedGroup.uuid;
		this.state.proj.custUuid='';
		this.state.proj.projCode='';
		this.state.proj.projName='';
		this.state.proj.beginDate='';
		this.state.proj.biziType='';
		this.state.proj.projStatus='运行';
		this.state.proj.payType='';
		this.state.proj.induType='0';
		this.state.proj.projType='';
		this.state.proj.delivArea='';
		this.state.proj.techArch='';
		this.state.proj.manMonth='';
		this.state.proj.projAmount='';
		this.state.proj.projLoc='';
		this.state.proj.endDate='';
		this.state.proj.pmName='';
		this.state.proj.projStage='';
		this.state.proj.projDesc='';
        this.state.proj.manDemand = '';
        this.state.proj.beginTime = '09:00';
        this.state.proj.endTime = '18:00';
    ...
    onClickSave: function () {
        ...
        if (Common.formValidator(this, this.state.proj)) {
            ...
            ProjActions.createProjInfo(this.state.proj);
        }
	},
	...
	render : function(){
        ...
        var boo = this.state.proj.projCode? false : true ;
		...
		return (
			<div style={{overflow:'hidden', height:'100%', paddingLeft: '4px'}}>
				<Tabs defaultActiveKey="2"  onChange={this.onTabChange} tabBarStyle={{paddingLeft: '16px', margin: '-36px 0 0'}} style={{width: '100%', height: '100%', padding: '36px 0 0'}}>
					...
					<TabPane tab="增加项目组" key="2" style={{width: '100%', height: '100%'}}>
                                ...
                                <Row>
                                    <Col span="12">
                                        <FormItem {...formItemLayout2} label="项目经理" required={false} colon={true} className={layoutItem} help={hints.pmNameHint} validateStatus={hints.pmNameStatus}>
                                            <SearchResMember corpUuid={corpUuid} showError={this.showError} ref='empSearchBox' type="text" name="pmName" id="pmName" value={this.state.proj.pmName} onSelectMember={this.onSelectProj} />
                                        </FormItem>
                                    </Col>
                                    <Col span="12">
...
/*
	...
	<FormItem {...formItemLayout} label="项目地址" required={false} colon={true} className={layoutItem} help={hints.projLocHint} validateStatus={hints.projLocStatus}>
		<Input style={{zIndex:'2'}} type="text" name="projLoc" id="projLoc" value={this.state.proj.projLoc } onChange={this.handleOnChange}/>
	</FormItem>
*/
