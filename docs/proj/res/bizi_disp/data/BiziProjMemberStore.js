...
var BiziProjMemberStore = Reflux.createStore({
	...
	onCreateBiziProjMember: function(biziProjMember) {
		var url = this.getServiceUrl('bizi-proj-member/create');
		Utils.recordCreate(this, biziProjMember, url);
	},
	
	onUpdateBiziProjMember: function(biziProjMember) {
		var url = this.getServiceUrl('bizi-proj-member/update');
		Utils.recordUpdate(this, biziProjMember, url);
	},
...
module.exports = BiziProjMemberStore;
