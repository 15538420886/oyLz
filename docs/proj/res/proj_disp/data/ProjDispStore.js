...
var ProjDispStore = Reflux.createStore({
	listenables: [ProjDispActions],
	...
	onCreateProjInfo: function(projDisp) {
		var url = this.getServiceUrl('proj_info/create');
		Utils.recordCreate(this, projDisp, url);
	},
	
	onUpdateProjInfo: function(projDisp) {
		var url = this.getServiceUrl('proj_info/update');
		Utils.recordUpdate(this, projDisp, url);
	},
