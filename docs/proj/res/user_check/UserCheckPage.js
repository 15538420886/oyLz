...
var UserCheckPage = React.createClass({
    ...
    queryUserChkBook: function (chkDate) {
        ...
        filter.chkProj = ProjContext.selectedPool.uuid;
    ...
    showError: function (msg) {
        MsgActions.showError('res-member-snap', 'create-pool-chk', msg);
    },
    ...
    handleClickCheckBook: function (e) {
        var data = {
            ...
            poolName: ProjContext.selectedPool.poolName,
            pmCode: ProjContext.selectedPool.pmCode,
        }
        ...
        // 创建考勤表
        var self = this;
        var url = Utils.projUrl + '/res-member-snap/create-pool-chk';
    ...
    render: function () {
        var projUuid = ProjContext.selectedPool.uuid;
        ...
        return (
            <div className='grid-page' style={{ padding: cs.padding }}>
                <div style={{ margin: cs.margin }}>
                    <ServiceMsg ref='mxgBox' svcList={['user-chk-book/retrieve', 'user-chk-book/remove', 'res-member-snap/create-pool-chk']} />
