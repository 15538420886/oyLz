...
import {Button, Table, Icon, Modal, Input, DatePicker} from 'antd';
const Search = Input.Search;
const dateFormat = 'YYYY-MM-DD';
var Common = require('../../../public/script/common');
var Utils = require('../../../public/script/utils');
var DispLogStore = require('./data/DispLogStore');
...
var DispLogPage = React.createClass({
    ...
    mixins: [Reflux.listenTo(DispLogStore, "onServiceComplete")],
	...
	handleQueryClick : function(event) {
		...
		DispLogActions.retrieveProjMemberPage(poolUuid,chkDate, this.state.dispLogSet.startPage, pageRows);
	},
    componentDidMount: function () {
		...
		var poolUuid = ProjContext.selectedPool.uuid;
        DispLogActions.retrieveProjMember(poolUuid, today);
	},
	onChangePage: function(pageNumber){
        this.state.dispLogSet.startPage = pageNumber;
	...
	onChangeView: function(e) {
        ...
        DispLogActions.retrieveProjMember(poolUuid, chkDate);
	...
	render : function() {
		var recordSet = this.state.dispLogSet.recordSet;
		var pag = {showQuickJumper: true, total:this.state.dispLogSet.totalRow, pageSize:this.state.dispLogSet.pageRow,
                current:this.state.dispLogSet.startPage, size:'large', showSizeChanger:true, onShowSizeChange:this.onShowSizeChange, onChange: this.onChangePage};
