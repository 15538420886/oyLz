...
var SearchGroupMember = React.createClass({
    ...
    onServiceComplete: function (data) {
        ...
        if (!sp.state.modal) {
            ...
            if (len === 0) {
                var errMsg = (data.errMsg === '') ? '没有在项目群中找到人员' : data.errMsg;
                ...
                this.refs.SelectProjMemberPage.clear(data, 'group');
    ...
    onSearch: function (value) {
        ...
        SearchProjMemberActions.retrieveGroupMemberPage(filter, 1, 10);
    },
...
SearchGroupMember.propTypes = propTypes;
module.exports = SearchGroupMember;
