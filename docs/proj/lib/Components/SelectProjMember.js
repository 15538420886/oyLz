...
var SelectProjMember = React.createClass({
    ...
    onChangePage: function (pageNumber) {
        ...
        if (this.state.queryType === 'group') {
            SearchProjMemberActions.retrieveGroupMemberPage(filter, pageNumber, this.state.projMemberSet.pageRow);
        }
        else {
            SearchProjMemberActions.retrieveProjMemberPage(filter, pageNumber, this.state.projMemberSet.pageRow);
        }
    },
...
export default SelectProjMember;
