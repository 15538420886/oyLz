...
var CheckQueryStore = require('../../proj/check_query/data/CheckQueryStore');
var CheckQueryActions = require('../../proj/check_query/action/CheckQueryActions');
...
var CheckQueryPage = React.createClass({
    ...
    mixins: [Reflux.listenTo(CheckQueryStore, "onServiceComplete"), ProjCodeMap(), CodeMap()],
