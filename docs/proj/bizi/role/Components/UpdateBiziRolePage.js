...
var UpdateBiziRolePage = React.createClass({
	...
	onClickSave : function(){
		if(Common.formValidator(this, this.state.projRole)){
			...
			BiziRoleActions.updateBiziProjRole( this.state.projRole );
		}
	},
		...
		return (
			<div style={{overflow:'hidden', height:'100%', paddingLeft: '4px'}}>
				<Tabs defaultActiveKey="2"  onChange={this.onTabChange} tabBarStyle={{paddingLeft: '16px', margin: '-36px 0 0'}} style={{width: '100%', height: '100%', padding: '36px 0 0'}}>
					...
					<TabPane tab="修改管理人员信息" key="2" style={{width: '100%', height: '100%'}}>
						<div style={{padding:"20px 0 16px 0px", height: '100%',overflowY: 'auto'}}>
							<ServiceMsg ref='mxgBox' svcList={['bizi-proj-role/update']}/>
...
export default UpdateBiziRolePage;
