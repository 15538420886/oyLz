...
var UserCheckStore = require('../../proj/user_check/data/UserCheckStore.js');
var UserCheckActions = require('../../proj/user_check/action/UserCheckActions');
import CreateUserCheckPage from './Components/CreateUserCheckPage';
import BatchCheckPage from './Components/BatchCheckPage';
...
var filterValue = '';
var UserCheckPage = React.createClass({
    ...
    queryUserChkBook: function (chkDate) {
        ...
        filter.chkProj = ProjContext.selectedBiziProj.uuid;
    ...
    showError: function (msg) {
        MsgActions.showError('res-member-snap', 'create-bizi-chk', msg);
    },

    handleClickCheckBook: function (e) {
        var data = {
            corpUuid: window.loginData.compUser.corpUuid,
            projUuid: ProjContext.selectedBiziProj.uuid,
            chkDate: this.state.workDate,
            projName: ProjContext.selectedBiziProj.projName,
            projLoc: ProjContext.selectedBiziProj.projLoc,
            pmCode: ProjContext.selectedBiziProj.pmCode,
        }
        ...
        // 创建考勤表
        var self = this;
        var url = Utils.projUrl + '/res-member-snap/create-bizi-chk';
    ...
    render: function () {
        ...
        if (this.state.viewType === '2') {
            ...
            tableBox =
                <div style={{ width: '100%', padding: '0 18px 18px 20px' }} className='grid-body'>
        ...
        return (
            <div className='grid-page' style={{ padding: cs.padding }}>
                <div style={{ margin: cs.margin }}>
                    <ServiceMsg ref='mxgBox' svcList={['user-chk-book/retrieve', 'user-chk-book/remove', 'res-member-snap/create-bizi-chk']} />
