...
var CreateGroupManPage = React.createClass({
    ...
    clear : function(filter){
        this.state.hints = {};
        this.state.groupMan.uuid='';
        this.state.groupMan.filter = filter;
        this.state.groupMan.roleName='';
        this.state.groupMan.perName='';
        this.state.groupMan.beginDate='';
        this.state.groupMan.corpUuid = window.loginData.compUser.corpUuid;
        this.state.groupMan.grpUuid = ProjContext.selectedGroup.uuid;
    ...
    onClickSave : function(){
        if(Common.formValidator(this, this.state.groupMan)){
            ...
            GroupManActions.createGroupMan( this.state.groupMan );
        }
    },
        ...
        return (
            <div style={{overflow:'hidden', height:'100%', paddingLeft: '4px'}}>
                <Tabs defaultActiveKey="2"  onChange={this.onTabChange} tabBarStyle={{paddingLeft: '16px', margin: '-36px 0 0'}} style={{width: '100%', height: '100%', padding: '36px 0 0'}}>
                    ...
                    <TabPane tab="增加项目群管理员" key="2" style={{width: '100%', height: '100%'}}>
                        <div style={{padding:"24px 0 16px 8px", height: '100%',overflowY: 'auto'}}>
                            <ServiceMsg ref='mxgBox' svcList={['group-man/create']}/>
...
export default CreateGroupManPage;